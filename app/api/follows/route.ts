...
export async function GET(req: NextRequest) {
    try {
        ...
        // Support both userId and username
        ...
        if (targetUserId && type) {
            if (type === 'followers') {
                ...
                const followers = await followsCollection.find({ followingId: new ObjectId(targetUserId) }).toArray();
                ...
                const following = await followsCollection.find({ followerId: new ObjectId(targetUserId) }).toArray();
