...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!user) {
        setError("Email not found. Please check or create a new account.");
        setIsLoading(false);
        return;
      }
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center">
            <span className="text-sm text-gray-600">
              ...
              <Link href="/auth/register" className="font-semibold text-pink-600 hover:text-pink-500 transition-colors">
                Sign up
              </Link>
            </span>
          </div>
